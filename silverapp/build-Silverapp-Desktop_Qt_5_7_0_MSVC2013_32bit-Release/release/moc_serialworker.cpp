...
#include "../../Silverapp/serialworker.h"
...
QT_MOC_LITERAL(1, 13, 17), // "serialDataArrived"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 13), // "newSerialData"
QT_MOC_LITERAL(4, 46, 12), // "errorChanged"
QT_MOC_LITERAL(5, 59, 28), // "QSerialPort::SerialPortError"
QT_MOC_LITERAL(6, 88, 5), // "error"
QT_MOC_LITERAL(7, 94, 15), // "handleReadyRead"
QT_MOC_LITERAL(8, 110, 11), // "handleError"
QT_MOC_LITERAL(9, 122, 15), // "serialPortError"
QT_MOC_LITERAL(10, 138, 23), // "changeCurrentSerialPort"
QT_MOC_LITERAL(11, 162, 18) // "portNameToChangeTo"

    },
    "SerialWorker\0serialDataArrived\0\0"
    "newSerialData\0errorChanged\0"
    "QSerialPort::SerialPortError\0error\0"
    "handleReadyRead\0handleError\0serialPortError\0"
    "changeCurrentSerialPort\0portNameToChangeTo"
};
...
void SerialWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->serialDataArrived((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        case 1: _t->errorChanged((*reinterpret_cast< QSerialPort::SerialPortError(*)>(_a[1]))); break;
        case 2: _t->handleReadyRead(); break;
        case 3: _t->handleError((*reinterpret_cast< QSerialPort::SerialPortError(*)>(_a[1]))); break;
        case 4: _t->changeCurrentSerialPort((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (SerialWorker::*_t)(const QByteArray & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialWorker::serialDataArrived)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SerialWorker::*_t)(QSerialPort::SerialPortError );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialWorker::errorChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SerialWorker::serialDataArrived(const QByteArray & _t1)
{
...
// SIGNAL 1
void SerialWorker::errorChanged(QSerialPort::SerialPortError _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
